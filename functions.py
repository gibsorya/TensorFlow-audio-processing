"""
Original Author:    Dario Cazzani

Converted to TF 2.0 by Ryan Gibson 
"""
#!/usr/bin/python
from __future__ import division
# This may need to change depending on how you imported tensorflow. If this doesn't work, try just using import tensorflow
